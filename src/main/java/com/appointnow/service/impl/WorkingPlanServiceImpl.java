...
import com.appointnow.dao.WorkingPlanRepository;
import com.appointnow.entity.WorkingPlan;
import com.appointnow.model.TimePeriod;
import com.appointnow.security.CustomUserDetails;
import com.appointnow.service.WorkingPlanService;
...
public class WorkingPlanServiceImpl implements WorkingPlanService {
    ...
    @Override
    @PreAuthorize("#updateDate.provider.id == principal.id")
