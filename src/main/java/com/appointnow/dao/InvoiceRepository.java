...
public interface InvoiceRepository extends JpaRepository<Invoice, Integer> {
    ...
    @Query("select i from Invoice i where i.issued >= :beginningOfCurrentMonth")
    List<Invoice> findAllIssuedInCurrentMonth(@Param("beginningOfCurrentMonth")LocalDateTime beginningOfCurrentMonth);
